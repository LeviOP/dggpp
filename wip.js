...
(function() {
    ...
    settings.innerHTML += '<h4>Better D.GG</h4><div class="form-group checkbox"><label title="Clicking on emotes to add them to your input"><input id="clickForEmote" class="dggppSCheck" type="checkbox">Click for emote</label></div>'
    ...
    var currentMessage = ""
    document.querySelector("#chat-input-control").onkeypress = (e) => {
        setTimeout(() => {
            if (e.key === "Enter") {
                if (document.querySelector("#chat-input-control").value.trim() === "/tiny") {
                }
            }
